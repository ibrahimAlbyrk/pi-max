...
const websearchSchema = Type.Object({
    ...
    count: Type.Optional(Type.Number({ description: `Number of results to return (default: ${DEFAULT_COUNT}, max: ${MAX_COUNT})` })),
    site: Type.Optional(Type.String({ description: "Restrict search to a specific site (e.g., 'stackoverflow.com', 'github.com')" })),
});
/**
...
export function createWebsearchTool() {
    return {
        ...
        execute: async (_toolCallId, { query, count, site }, signal) => {
            ...
            try {
                ...
                if (error.name === "AbortError" || error.name === "TimeoutError") {
                    ...
                    return {
                        ...
                        details: { query, provider: provider.name, resultCount: 0 },
                    };
                }
                throw error;
            }
